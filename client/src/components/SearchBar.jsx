...
const handleSubmit = (event) =>{
	...
	return (
		<form onSubmit={handleSubmit} action='/results' className='flex flex-col md:flex-row items-center max-w-4xl mx-auto'>
			...
			<input onChange={handleInput} type="text" placeholder="Search..." className="w-full px-4 py-2 md:px-7 md:py-1 rounded-md focus:outline-none focus:ring-2 focus:ring-goldenOrange-dark" />
		</div>
