        ...
        {getCurrentSlides().map((guide, index) => (
          ...
          >
            <div className="bg-white shadow-lg rounded-lg p-6 mx-4">
              <div className="font-bold text-xl mb-2">{guide.title}</div>
              <p className="text-gray-700 text-base mb-4">{guide.content}</p>
              ...
              {/* <Link to="/{guide._id}" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              Read Guide</Link>... when detailed guide page done.*/}
              <a
                href={guide.link}
